...
public class DepthRenderer {
    ...
    public void createOnGlThread(Context context) throws IOException {
        ...
        int vertexShader =
                ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.depth_vertex_shader);
        int fragmentShader =
                ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, R.raw.depth_fragment_shader);
